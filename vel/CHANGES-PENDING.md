...
|---|---|---|---|---|
| A1 | **Reco remarks must name the side at fault.** A line that matches on invoice number but differs on GSTIN should say whether the SUPPLIER or the RECIPIENT GSTIN is wrong, not only "recipient GSTIN differs". In the case on screen the 2B's own GSTIN was wrong, not the register's. | ITC Register 2025-26, GSTR-2B Apr25-Aug26 | M1 | todo |
