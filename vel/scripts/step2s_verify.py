...
try:
    ...
    tot = 0
    for n in ["SR vs GSTR-1", "Month-on-Month", "Summary", "SR Data", "GSTR-1 Data"]:
    ...
    EXP = {26: [8927118980.77, 64753.60, -486125232.19, 28170523.64, 381672455.66, -146306990.57, 8704594490.91],
